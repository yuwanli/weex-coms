<template>
    <div :class="['weex-popup','weex-popup_'+popupType]" ref="bdPopup" v-if="showPopup || showInCurrent">
        <div class="weex-popup_mask" ref="bdPopupMask" @click="maskClick"></div>
        <div :class="['weex-popup_content','weex-popup_content_'+popupType]" :style="computedStyle" ref="popupContent" @click.stop>
            <slot name="content"></slot>
            <slot name="close">
                <image v-if="showClose" class="weex-popup_img" @click="hidePopup" src="http://h0.hucdn.com/open/201824/4654c1178aca4b3b_120x120.png"></image>
            </slot>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        commonHandle(flag) {
            let resObj = {
                bdPopupMask: this.$refs.bdPopupMask,
            ...
            const handle = () => {
                animation.transition(resObj.bdPopupMask, {
