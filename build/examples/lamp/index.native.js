...
__vue_options__.__file = "/Users/yuwanli/Desktop/myself/weex-coms/examples/lamp/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-512f51ae"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index_vue__ = __webpack_require__(12);
...
__vue_options__.__file = "/Users/yuwanli/Desktop/myself/weex-coms/components/weex-lamp/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-68ebc81e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_weex_bindingx__ = __webpack_require__(11);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_weex_lamp_index_js__ = __webpack_require__(7);
//
//
//
//
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._t("before"), (_vm.lampType === 'single') ? [_c('div', {
    ref: "wrapper",
    staticClass: ["lamp-wrapper"],
    style: {
      height: _vm.lampData.length * _vm.itemHeight + 'px'
    }
  }, [_vm._l((_vm.lampData), function(item) {
    return [_vm._t("item", [_c('text', {
      key: item,
      staticClass: ["lamp-item"],
      style: _vm.itemStyle
    }, [_vm._v(_vm._s(item))])], {
      data: item
    })]
  ...
  }), _vm._l(((_vm.canVerticalRun && _vm.lampData)), function(item) {
    return _c('text', {
      key: item.id,
      staticClass: ["lamp-item"],
      style: _vm.itemStyle
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["text"]
  }, [_vm._v("是我们这边在封装的跑马灯组件的时候遇到一些问题")]), _c('text', {
    staticClass: ["text"]
  }, [_vm._v("去除过渡动画，当枚举数量越多时，在安卓上的误差会越来越大，在ios上表现良好")]), _c('text', {
    staticClass: ["text"]
  }, [_vm._v("猜测是因为‘px->原生尺寸‘这个转换的过程中有误差产生，然后数据量大的时候，导致误差会越来越大")]), _c('text', {
    staticClass: ["text"]
  }, [_vm._v("希望官方能查下这个问题，且能解决下")]), _c('text', {
    staticClass: ["text"]
  }, [_vm._v("以下是去除过渡效果的时候，为展示效果都加上了边框")]), _c('weex-lamp', {
    ref: "lamp1",
    staticClass: ["test"],
    attrs: {
      "containerStyle": _vm.containerStyle,
      "lampData": _vm.lampData,
      "itemStyle": _vm.itemStyle,
      "aniTime": _vm.aniTime,
      "stopTime": _vm.stopTime,
    ...
    staticClass: ["text"]
  }, [_vm._v("以下是另一种形式跑马灯")]), _c('weex-lamp', {
    ref: "lamp3",
    attrs: {
      "containerStyle": _vm.containerStyle1,
      "lampData": _vm.lampData,
      "itemStyle": _vm.itemStyle1,
      "aniTime": _vm.aniTime,
      "itemHeight": _vm.itemHeight,
      "lampType": _vm.lampType
    }
  })], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
